...
constructor(private val context: Context, private val sharedPreferences: SharedPreferences) {
    ...
    val appPreventSleep: Boolean
        get() = getBoolPref(
            R.string.key_setting_app_preventsleep,
    ...
    var cameraRotate: Float
        ...
        set(value) = this.sharedPreferences.edit().putString(PREF_CAMERA_ROTATE, value.toString())
            .apply()

    var appLaunchUrl: String
        get() = getStringPref(
            R.string.key_setting_app_launchurl,
            R.string.default_setting_app_launchurl
        )
        set(launchUrl) {
            sharedPreferences.edit()
                .putString(context.getString(R.string.key_setting_app_launchurl), launchUrl).apply()
            settingsUpdated()
        }

    val appShowActivity: Boolean
        get() = getBoolPref(
            R.string.key_setting_app_showactivity,
            R.string.default_setting_app_showactivity
        )

    var cameraEnabled: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_enabled,
            R.string.default_setting_camera_enabled
        )
        set(value) {
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_setting_camera_enabled), value).apply()
        }

    var cameraId: Int
        get() = this.sharedPreferences.getInt(
            context.getString(R.string.setting_camera_cameraid),
            0
        )
        set(value) {
            this.sharedPreferences.edit()
                .putInt(context.getString(R.string.setting_camera_cameraid), value).apply()
        }

    var cameraMotionEnabled: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_motionenabled,
            R.string.default_setting_camera_motionenabled
        )
        set(value) {
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_setting_camera_motionenabled), value)
                .apply()
        }
    ...
    val cameraMotionMinLuma: Int
        get() = Integer.valueOf(
            getStringPref(
                R.string.key_setting_camera_motionminluma,
    ...
    val cameraMotionWake: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_motionwake,
            R.string.default_setting_camera_motionwake
        )

    val cameraMotionBright: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_motionbright,
            R.string.default_setting_camera_motionbright
        )

    var cameraFaceEnabled: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_faceenabled,
            R.string.default_setting_camera_faceenabled
        )
        set(value) {
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_setting_camera_faceenabled), value)
                .apply()
        }

    val cameraFaceWake: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_facewake,
    ...
    val cameraFaceRotation: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_facerotation,
            R.string.default_setting_camera_facerotation
        )

    var cameraQRCodeEnabled: Boolean
        get() = getBoolPref(
            R.string.key_setting_camera_qrcodeenabled,
            R.string.default_setting_camera_qrcodeenabled
        )
        set(value) {
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_setting_camera_qrcodeenabled), value)
                .apply()
        }

    val motionResetTime: Int
        get() = getStringPref(
            R.string.key_setting_motion_clear,
    ...
    val httpPort: Int
        get() =
            try {
                getStringPref(
                    R.string.key_setting_http_port,
    ...
    var mqttTlsEnabled: Boolean
        ...
        set(value) =
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_setting_mqtt_tls_enabled), value).apply()

    var mqttBroker: String
        get() = getStringPref(
            R.string.key_setting_mqtt_servername,
            R.string.default_setting_mqtt_servername
        )
        set(value) =
            sharedPreferences.edit()
                .putString(context.getString(R.string.key_setting_mqtt_servername), value).apply()

    val mqttServerPort: Int
        get() = getStringPref(
            R.string.key_setting_mqtt_serverport,
            R.string.default_setting_mqtt_serverport
        ).trim().toInt()

    val mqttBaseTopic: String
        get() = getStringPref(
            R.string.key_setting_mqtt_basetopic,
            R.string.default_setting_mqtt_basetopic
        )

    val mqttClientId: String
        get() = getStringPref(
            R.string.key_setting_mqtt_clientid,
            R.string.default_setting_mqtt_clientid
        )

    var mqttUsername: String
        get() = getStringPref(
            R.string.key_setting_mqtt_username,
            R.string.default_setting_mqtt_username
        )
        set(value) =
            sharedPreferences.edit()
                .putString(context.getString(R.string.key_setting_mqtt_username), value).apply()

    var mqttPassword: String
        get() = getStringPref(
            R.string.key_setting_mqtt_password,
            R.string.default_setting_mqtt_password
        )
        set(value) =
            sharedPreferences.edit()
                .putString(context.getString(R.string.key_setting_mqtt_password), value).apply()

    val mqttSensorFrequency: Int
        get() = getStringPref(
            R.string.key_setting_mqtt_sensorfrequency,
            R.string.default_setting_mqtt_sensorfrequency
        ).trim().toInt()

    val mqttDiscovery: Boolean
        get() = getBoolPref(
            R.string.key_setting_mqtt_discovery,
            R.string.default_setting_mqtt_home_assistant_discovery
        )

    val mqttDiscoveryTopic: String
        get() = getStringPref(
            R.string.key_setting_mqtt_discovery_topic,
            R.string.default_setting_mqtt_discovery_topic
        )

    val mqttDiscoveryDeviceName: String
        get() = getStringPref(
            R.string.key_setting_mqtt_discovery_name,
            R.string.default_setting_mqtt_home_assistant_name
        )

    val sensorsEnabled: Boolean
        get() = getBoolPref(
            R.string.key_setting_sensors_enabled,
            R.string.default_setting_sensors_value
        )

    val hardwareAccelerated: Boolean
        get() = getBoolPref(
            R.string.key_hadware_accelerated_enabled,
            R.string.default_hardware_accelerated_value
        )

    var browserUserAgent: String
        get() = getStringPref(
            R.string.key_setting_browser_user_agent,
            R.string.default_browser_user_agent
        )
        set(value) {
            sharedPreferences.edit()
                .putString(context.getString(R.string.key_setting_browser_user_agent), value)
                .apply()
            settingsUpdated()
        }
    ...
    var browserRefresh: Boolean
        get() = this.sharedPreferences.getBoolean(
            context.getString(R.string.key_pref_browser_refresh),
            true
        )
        set(value) {
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_pref_browser_refresh), value).apply()
        }

    val cameraFPS: Float
        get() = try {
            getStringPref(R.string.key_setting_camera_fps, R.string.default_camera_fps).trim()
                .toFloat()
        } catch (e: Exception) {
            15.0F
        }
    ...
    val zoomLevel: Float
        get() {
            val value = sharedPreferences.getString(
                context.getString(R.string.key_setting_zoomlevel),
                "1.0"
            )
    ...
    var inactivityTime: Long
        ...
        set(value) {
            sharedPreferences.edit()
                .putLong(context.getString(R.string.key_screensaver_inactivity_time), value).apply()
        }
    ...
    var screenSaverDimValue: Int
        ...
        set(value) {
            sharedPreferences.edit()
                .putInt(context.getString(R.string.key_screensaver_dim_value), value).apply()
        }
    ...
    var hasBlankScreenSaver: Boolean
        ...
        set(value) =
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_screensaver_blank), value).apply()

    var hasDimScreenSaver: Boolean
        get() = getBoolPref(R.string.key_screensaver_dim, R.string.default_screensaver_dim)
        set(value) =
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_screensaver_dim), value).apply()

    var hasClockScreenSaver: Boolean
        get() = getBoolPref(R.string.key_screensaver, R.string.default_screensaver)
        set(value) =
            sharedPreferences.edit().putBoolean(context.getString(R.string.key_screensaver), value)
                .apply()

    var hasScreenSaverWallpaper: Boolean
        get() = getBoolPref(
            R.string.key_screensaver_wallpaper,
            R.string.default_screensaver_wallpaper
        )
        set(value) =
            sharedPreferences.edit()
                .putBoolean(context.getString(R.string.key_screensaver_wallpaper), value).apply()
    ...
    var screenBrightness: Int
        ...
        set(value) {
            sharedPreferences.edit()
                .putInt(context.getString(R.string.key_setting_screen_brightness), value).apply()
        }
    ...
    var screenScreenSaverBrightness: Int
        ...
        set(value) {
            sharedPreferences.edit()
                .putInt(context.getString(R.string.key_setting_screensaver_brightness), value)
                .apply()
        }
    ...
    val ignoreSSLErrors: Boolean
        get() = getBoolPref(
            R.string.key_setting_ignore_ssl_errors,
    ...
    fun hasSettingsUpdates(): Boolean {
        val updates = sharedPreferences.getBoolean(PREF_BROWSER_SETTING_UPDATED, false)
        sharedPreferences.edit().putBoolean(PREF_BROWSER_SETTING_UPDATED, false).apply()
        return updates
    }

    fun settingsUpdated() {
        sharedPreferences.edit().putBoolean(PREF_BROWSER_SETTING_UPDATED, true).apply()
    }
    ...
    companion object {
        ...
        const val PREF_BROWSER_SETTING_UPDATED = "not_a_real_pref"
        ...
        const val PREF_ZOOM = "pref_zoom_level"
